...
<body>
    ...
    <div class="head">
        ...
        <div class="sub">Subject Paper Master</div>
    </div>

    <div class="title">Subject Paper For Session- {{ $sessionYear }}</div>
    ...
    @forelse($groups as $groupLabel => $papers)
        @if($showGroups ?? true)
            <div class="group-head">Group: {{ $groupLabel }}</div>
        @endif
        <table class="papers">
            <thead>
                <tr>
